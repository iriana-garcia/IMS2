...
@FacesValidator("severalEmailValidator")
public class SeveralEmailValidator implements Validator, ClientValidator {
	...
	public void validate(FacesContext context, UIComponent component,
		...
		for (int i = 0; i < listEmail.length; i++) {
			if (!pattern.matcher(listEmail[i]).matches()) {
